...
/// 基础列表处理器
open class RxBasicTableViewReactor: Reactor, RxRowHeightLayoutable {
    ...
    /// 列表数据源
    open var dataSource = RxTableViewSectionedAnimatedReloadDataSource<RxBasicListModel>()
    /// 顶部刷新处理器
