...
class TestView: UIView, ViewStyleConfigurable {
    ...
    /// 更新视图布局
    fileprivate func updateLayout(_ viewStyle: TestViewStyle? = nil) {
    ...
    func updateStyle(_ viewStyle: TestViewStyle) {
        ...
        // 通常样式的改变需要更新视图，比如字体大小调整
        updateLayout(viewStyle)
    }
}
